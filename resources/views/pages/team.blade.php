...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Gestão de Equipe'])
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h6>Lista de Colaboradores da Equipe</h6>
                    </div>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th
                                            class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">
                                            Empregado em</th>
                                        <th class="text-secondary opacity-7">Açoes</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2">
                                                ...
                                                <div class="my-auto">
                                                    <h6 class="mb-0 text-sm">Intranet</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2">
                                                ...
                                                <div class="my-auto">
                                                    <h6 class="mb-0 text-sm">WebForm</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
