            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="/img/teste.jpeg" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
                    </div>
                </div>
                        ...
                        <ul class="nav nav-pills nav-fill p-1" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link mb-0 px-0 py-1 d-flex align-items-center justify-content-center "
                                    ...
                                    <span class="ms-2">Definicoes</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <form role="form" method="POST" action={{ route('profile.update') }} enctype="multipart/form-data">
                        ...
                        <div class="card-header pb-0">
                            <div class="d-flex align-items-center">
                                ...
                                <button type="submit" class="btn btn-primary btn-sm ms-auto">Gravar</button>
                            </div>
                        </div>
                        <div class="card-body">
                ...
                <div class="card card-profile">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="text-center mt-4">
                            <h5>
                                Delson<span class="font-weight-light">, 35</span>
                            </h5>
                            <div class="h6 font-weight-300">
                                <i class="ni location_pin mr-2"></i>Mozambique, Maputo
                            </div>
                            <div class="h6 mt-4">
                                <i class="ni business_briefcase-24 mr-2"></i>Solution Manager
                            </div>
                            <div>
                                <i class="ni education_hat mr-2"></i>Safeline
                            </div>
                        </div>
                    </div>
                </div>
