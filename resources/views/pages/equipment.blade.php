...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Recursos Humanos'])
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-header pb-0">
                        <div class="d-flex align-items-center">
                            ...
                            <a href="{{ route('page', ['page' => 'equipment-create']) }}" class="btn btn-primary btn-sm ms-auto">Adicionar Equimento</a>
                        </div>
                    </div>
                    <div class="card-header pb-0">
